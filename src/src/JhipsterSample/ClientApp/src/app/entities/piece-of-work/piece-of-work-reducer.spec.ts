...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_PIECEOFWORK_LIST actions", async () => {
    ...
    it("dispatches FETCH_PIECEOFWORK actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_PIECEOFWORK actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_PIECEOFWORK actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_PIECEOFWORK actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_PIECEOFWORK actions", async () => {
      const expectedActions = [
        {
